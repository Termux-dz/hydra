...
print(logo)
time.sleep(4)
os.system("pkg install git;git clone https://github.com/vanhauser-thc/thc-hydra;cd thc-hydra;./configure;make install;clear")
print('\033[1;32mThe installation succeeded you can know it by typing ./hydra -help ')